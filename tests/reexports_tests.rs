...
fn test_root_exports_conditional_consumer_types() {
    ...
    assert_type_is_exported::<qubit_function::RcConditionalConsumer<i32>>(
    ...
    assert_type_is_exported::<
        qubit_function::BoxConditionalBiConsumerOnce<i32, i64>,
    >("BoxConditionalBiConsumerOnce");
    assert_type_is_exported::<
        qubit_function::BoxConditionalStatefulConsumer<i32>,
    ...
    assert_type_is_exported::<
        qubit_function::ArcConditionalStatefulConsumer<i32>,
    >("ArcConditionalStatefulConsumer");
    assert_type_is_exported::<
        qubit_function::BoxConditionalStatefulBiConsumer<i32, i64>,
    >("BoxConditionalStatefulBiConsumer");
    assert_type_is_exported::<
        qubit_function::RcConditionalStatefulBiConsumer<i32, i64>,
    >("RcConditionalStatefulBiConsumer");
    assert_type_is_exported::<
        qubit_function::ArcConditionalStatefulBiConsumer<i32, i64>,
...
fn test_root_exports_conditional_function_types() {
    assert_type_is_exported::<
        qubit_function::BoxConditionalFunctionOnce<i32, i64>,
    >("BoxConditionalFunctionOnce");
    assert_type_is_exported::<
        qubit_function::BoxConditionalBiFunctionOnce<i32, i64, String>,
    >("BoxConditionalBiFunctionOnce");
    assert_type_is_exported::<
        qubit_function::BoxConditionalMutatingFunction<i32, i64>,
    >("BoxConditionalMutatingFunction");
    assert_type_is_exported::<
        qubit_function::RcConditionalMutatingFunction<i32, i64>,
    >("RcConditionalMutatingFunction");
    assert_type_is_exported::<
        qubit_function::ArcConditionalMutatingFunction<i32, i64>,
    >("ArcConditionalMutatingFunction");
    assert_type_is_exported::<
        qubit_function::BoxConditionalMutatingFunctionOnce<i32, i64>,
    >("BoxConditionalMutatingFunctionOnce");
    assert_type_is_exported::<
        qubit_function::BoxConditionalStatefulMutatingFunction<i32, i64>,
    >("BoxConditionalStatefulMutatingFunction");
    assert_type_is_exported::<
        qubit_function::RcConditionalStatefulMutatingFunction<i32, i64>,
    >("RcConditionalStatefulMutatingFunction");
    assert_type_is_exported::<
        qubit_function::ArcConditionalStatefulMutatingFunction<i32, i64>,
...
fn test_root_exports_conditional_transformer_types() {
    assert_type_is_exported::<
        qubit_function::BoxConditionalBiTransformer<i32, i64, String>,
    >("BoxConditionalBiTransformer");
    assert_type_is_exported::<
        qubit_function::RcConditionalBiTransformer<i32, i64, String>,
    >("RcConditionalBiTransformer");
    assert_type_is_exported::<
        qubit_function::ArcConditionalBiTransformer<i32, i64, String>,
    >("ArcConditionalBiTransformer");
    assert_type_is_exported::<
        qubit_function::BoxConditionalBiTransformerOnce<i32, i64, String>,
...
fn test_module_roots_export_conditional_types() {
    assert_type_is_exported::<
        qubit_function::consumers::BoxConditionalConsumer<i32>,
    >("BoxConditionalConsumer");
    assert_type_is_exported::<
        qubit_function::consumers::ArcConditionalStatefulBiConsumer<i32, i64>,
    >("ArcConditionalStatefulBiConsumer");
    assert_type_is_exported::<
        qubit_function::functions::BoxConditionalFunctionOnce<i32, i64>,
    >("BoxConditionalFunctionOnce");
    assert_type_is_exported::<
        qubit_function::functions::ArcConditionalStatefulMutatingFunction<
            i32,
            i64,
        >,
    >("ArcConditionalStatefulMutatingFunction");
    assert_type_is_exported::<
        qubit_function::transformers::BoxConditionalBiTransformerOnce<
            i32,
            i64,
            String,
        >,
    >("BoxConditionalBiTransformerOnce");
    assert_type_is_exported::<
        qubit_function::transformers::RcConditionalBiTransformer<
            i32,
            i64,
            String,
        >,
...
fn test_root_exports_stateful_tester_types() {
    ...
    assert_type_is_exported::<qubit_function::BoxStatefulTester>(
        "BoxStatefulTester",
    );
    assert_type_is_exported::<qubit_function::RcStatefulTester>(
        "RcStatefulTester",
    );
    assert_type_is_exported::<qubit_function::ArcStatefulTester>(
        "ArcStatefulTester",
    );
}
