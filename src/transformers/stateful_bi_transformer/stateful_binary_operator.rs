...
// ============================================================================
// StatefulBinaryOperator Trait - Marker trait for StatefulBiTransformer<T, T,
// T>
// ============================================================================
...
/// same type `T`. This trait extends `StatefulBiTransformer<T, T, T>` to
/// provide semantic clarity for same-type binary operations. Equivalent to
/// Java's `BinaryOperator<T>` which extends `BiFunction<T, T, T>`.
///
/// # Automatic Implementation
///
/// This trait is automatically implemented for all types that implement
/// `StatefulBiTransformer<T, T, T>`, so you don't need to implement it
/// manually.
///
/// # Type Parameters
///
...
/// Blanket implementation of StatefulBinaryOperator for all
/// StatefulBiTransformer<T, T, T>
///
