...
use super::{
    BiPredicate, BiTransformer, BoxBiPredicate, BoxBiTransformer, impl_box_conditional_transformer,
...
/// - **Implements BiTransformer**: Can be used anywhere a `BiTransformer` is
///   expected
///
/// # Examples
///
