...
1. 使用 GitHub 账号登录
2. 选择 `qubit-ltd/qubit-function` 项目
3. 点击 "Set Up Project"
...
在 `qubit-function/README.md` 中添加：
...
- 🐛 Issue：https://github.com/qubit-ltd/qubit-function/issues
- 💬 讨论：https://github.com/qubit-ltd/qubit-function/discussions
