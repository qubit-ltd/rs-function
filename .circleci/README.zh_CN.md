...
本目录包含了 `qubit-function` 项目的 CircleCI 持续集成配置。
...
```bash
cargo llvm-cov --package qubit-function --lcov --output-path coverage.lcov
cargo llvm-cov --package qubit-function
```
...
**CircleCI 仪表板**：
```
https://app.circleci.com/pipelines/github/qubit-ltd/qubit-function
```
...
```markdown
[![CircleCI](https://circleci.com/gh/qubit-ltd/qubit-function.svg?style=svg)](https://circleci.com/gh/qubit-ltd/qubit-function)
```

或者使用 shields.io 风格：

```markdown
[![CircleCI](https://img.shields.io/circleci/build/github/qubit-ltd/qubit-function/main?label=build&logo=circleci)](https://circleci.com/gh/qubit-ltd/qubit-function)
```

效果预览：

![CircleCI Badge](https://img.shields.io/circleci/build/github/qubit-ltd/qubit-function/main?label=build&logo=circleci)
...
```markdown
[![codecov](https://codecov.io/gh/qubit-ltd/qubit-function/branch/main/graph/badge.svg)](https://codecov.io/gh/qubit-ltd/qubit-function)
```
...
创建 `qubit-function/.cargo-audit.toml`：
...
curl -X POST \
  ...
  https://circleci.com/api/v2/project/gh/qubit-ltd/qubit-function/pipeline
```
...
- 🐛 Issue：[GitHub Issues](https://github.com/qubit-ltd/qubit-function/issues)
- 💡 讨论：[GitHub Discussions](https://github.com/qubit-ltd/qubit-function/discussions)

---

**Haixing Hu, Qubit Co. Ltd.** | Apache-2.0 License
