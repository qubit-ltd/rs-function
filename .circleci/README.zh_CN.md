...
本目录包含了 `rust-function` 仓库的 CircleCI 持续集成配置。
...
**CircleCI 仪表板**：
```
https://app.circleci.com/pipelines/github/qubit-ltd/rust-function
```
...
```markdown
[![CircleCI](https://circleci.com/gh/qubit-ltd/rust-function.svg?style=svg)](https://circleci.com/gh/qubit-ltd/rust-function)
```

或者使用 shields.io 风格：

```markdown
[![CircleCI](https://img.shields.io/circleci/build/github/qubit-ltd/rust-function/main?label=build&logo=circleci)](https://circleci.com/gh/qubit-ltd/rust-function)
```

效果预览：

![CircleCI Badge](https://img.shields.io/circleci/build/github/qubit-ltd/rust-function/main?label=build&logo=circleci)
...
```markdown
[![codecov](https://codecov.io/gh/qubit-ltd/rust-function/branch/main/graph/badge.svg)](https://codecov.io/gh/qubit-ltd/rust-function)
```
...
创建 `rust-function/.cargo-audit.toml`：
...
curl -X POST \
  ...
  https://circleci.com/api/v2/project/gh/qubit-ltd/rust-function/pipeline
```
...
- 🐛 Issue：[GitHub Issues](https://github.com/qubit-ltd/rust-function/issues)
- 💡 讨论：[GitHub Discussions](https://github.com/qubit-ltd/rust-function/discussions)
